...
var Post = mongoose.model('Post');          // load post mongoose model
var Comment = mongoose.model('Comment');    // load comment mongoose model
var User = mongoose.model('User');			// load User mongoose module
...
// route for preloading post objects, logic to route parameter 'post'
